...
!(function (D, u) {
  ...
  function emojiSafeSplit(D, u, F, C) {
    ...
    for (var e, E, t = [], n = D.length, i = 0; i < n; i++)
      ((55296 <= (E = D.charAt(i)).charCodeAt(0) && E.charCodeAt(0) <= 56319) ||
        ...
        ((e = ((D.substr(i, 12).split(o) || [])[1] || '').length || 2), (E = D.substr(i, e)), (i += e - (t.emoji = 1))),
        t.push(
          '>' === E
            ? '&gt;'
            : '<' === E
            ? '&lt;'
            : !C || ' ' !== E || (' ' !== D.charAt(i - 1) && ' ' !== D.charAt(i + 1))
            ? E
            : '&nbsp;',
        )
    return t
  ...
  var E,
    ...
    C = u.toLowerCase(),
    f = { upperCase: new a(u), lowerCase: new a(C), upperAndLowerCase: new a(u + C) },
    e = {
      version: '3.12.3',
      name: 'scrambleText',
      ...
      init: function init(D, u, F) {
        if (
          (s || v(), (this.prop = 'innerHTML' in D ? 'innerHTML' : 'textContent' in D ? 'textContent' : 0), this.prop)
        ) {
          ...
          return (
            ...
            ('{original}' !== n && !0 !== n && null != n) || (n = r.original.join(C)),
      ...
      render: function render(D, u) {
        ...
        d &&
          (c._from && (W = c._dur - W),
          (D = 0 === W ? 0 : W < d ? 1e-6 : W === c._dur ? 1 : c._ease((W - d) / (c._dur - d)))),
          D < 0 ? (D = 0) : 1 < D && (D = 1),
          y && (D = 1 - D),
          (F = ~~(D * O + 0.5)),
          (E = D
          ...
          (i = H
            ? ((t = (r = y ? b : T) && 0 != F) ? "<span class='" + r + "'>" : '') +
              e +
              (t ? '</span>' : '') +
              ((n = (l = y ? T : b) && F !== O) ? "<span class='" + l + "'>" : '') +
              h +
              E +
              (n ? '</span>' : '')
            : e + h + E),
