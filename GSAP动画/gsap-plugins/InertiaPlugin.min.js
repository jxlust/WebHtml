...
!(function (t, e) {
  ...
  function r(t) {
    ...
    if (0.05 <= t - s)
      for (s = t; n; )
        ((e = n.g(n.t, n.p)) !== n.v1 || 0.2 < t - n.t1) && ((n.v2 = n.v1), (n.v1 = e), (n.t2 = n.t1), (n.t1 = t)),
          (n = n._next)
  }
  function t() {
  ...
  function ja(t, e, n, r) {
    if (e.linkedProps) {
      ...
      for (i = 0; i < f.length; i++)
        (a = e[(o = f[i])]) &&
          ((s = N(a.velocity) ? a.velocity : (c = c || C(t)) && c.isTracking(o) ? c.get(o) : 0),
                ...
                for (a in ((h = ja(t, m, S, w)), m))
                  z[a] ||
                    ...
                    O(s) &&
                      ...
                      'end' in s &&
                        ((s = ea(s, h && a in h ? h : l, s.max, s.min, a, m.radius, u)),
                        o && (M === e && (M = m = ca(e)), (m[a] = ba(s, m[a], 'end')))),
                      'max' in s && l > +s.max + 1e-10
                        ? ((p = s.unitFactor || x.unitFactors[a] || 1),
                          (g =
                            (f > s.max && s.min !== s.max) || (-15 < u * p && u * p < 45)
                              ? r + 0.1 * (n - r)
                              : ha(f, s.max, u)) +
                            i <
                            y && (y = g + i))
                        : 'min' in s &&
                          ...
                          ((p = s.unitFactor || x.unitFactors[a] || 1),
                          (g =
                            (f < s.min && s.min !== s.max) || (-45 < u * p && u * p < 15)
                              ? r + 0.1 * (n - r)
                              : ha(f, s.min, u)) +
                            i <
                            y && (y = g + i)),
            ...
            O(s) &&
              ...
              'max' in s && +s.max < g
                ? S || s.preventOvershoot
                  ? (l = s.max - c)
                  : (d = s.max - c - l)
                : 'min' in s && +s.min > g && (S || s.preventOvershoot ? (l = s.min - c) : (d = s.min - c - l))),
            this._props.push(a),
