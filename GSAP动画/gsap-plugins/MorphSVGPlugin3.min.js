...
!(function (t, e) {
    ...
    return 'path' !== T && t.getBBox
      ? ((s = (function _createPath(t, e) {
          var n,
            ...
            a = o.length
          for (e = ',' + e + ','; -1 < --a; )
            (n = o[a].nodeName.toLowerCase()), e.indexOf(',' + n + ',') < 0 && r.setAttributeNS(null, n, o[a].nodeValue)
          return r
        ...
        'rect' === T
            ...
            (n =
              a || i
                ? 'M' +
                  ...
                  'z'
                : 'M' + (r + g) + ',' + o + ' v' + p + ' h' + -g + ' v' + -p + ' h' + g + 'z'))
          : 'circle' === T || 'ellipse' === T
          ? ((l = 'circle' === T ? (a = i = M.r) * b : ((a = M.rx), (i = M.ry) * b)),
            (n =
              'M' +
              ((r = M.cx) + a) +
              ',' +
          ...
          : ('polyline' !== T && 'polygon' !== T) ||
            ((n =
              'M' +
              (r = (c = (t.getAttribute('points') + '').match(S) || []).shift()) +
              ',' +
              (o = c.shift()) +
              ' L' +
              c.join(',')),
  ...
  function arcToSegment(t, e, n, r, o, a, i, s, h) {
    if (t !== s || e !== h) {
      ...
      for (I = 0; I < W.length; I += 2)
        (P = W[I]), (m = W[I + 1]), (W[I] = P * G + m * k + N), (W[I + 1] = P * U + m * q + z)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < w; e++)
      if (
        ...
        'Z' === a && ((r = h), (o = l), (s.closed = !0)),
          ('L' === a || 0.5 < D(_ - r) || 0.5 < D(v - o)) && (Ac(_, v, r, o), 'L' === a && (e += 2)),
          (_ = r),
          (v = o)
      else if ('A' === a) {
        if (
    ...
    return (
      (e = s.length) < 6 ? (m.pop(), (e = 0)) : s[0] === s[e - 2] && s[1] === s[e - 1] && (s.closed = !0),
      (m.totalPoints = y + e),
      m
    )
  }
  function rawPathToString(t) {
    ...
    var e,
      ...
      i = t.length
    for (n = 0; n < i; n++) {
      for (o = t[n], a += 'M' + h(o[0]) + ',' + h(o[1]) + ' C', e = o.length, r = 2; r < e; r++)
  ...
  function V(t) {
    var e,
      ...
      h = s
    for (r = 6; r < o; r += 6)
      a < (e = t[r]) ? (a = e) : e < i && (i = e), s < (n = t[r + 1]) ? (s = n) : n < h && (h = n)
  ...
  function $(t, e, n, r, o) {
    var a,
      ...
      g = l - 2
    for (n *= 6, i = 0; i < l; i += 6)
      (h = t[(a = (i + n) % g)] - (e[i] - r)), (s = t[1 + a] - (e[i + 1] - o)), (c += v(s * s + h * h))
    return c
  }
  function _(t, e, n) {
    var r,
  ...
  function aa(t, e, n) {
    for (var r, o, a, i, s, h, l = t.length, c = 1e20, g = 0, p = 0; -1 < --l; )
      for (h = (r = t[l]).length, s = 0; s < h; s += 6)
        (o = r[s] - e), (a = r[s + 1] - n), (i = v(o * o + a * a)) < c && ((c = i), (g = r[s]), (p = r[s + 1]))
    return [g, p]
  }
  function ba(t, e, n, r, o, a) {
    ...
    for (i = n; i < c && !((e[i].size || V(e[i])) < p); i++)
      (s = e[i].centerX - u), (h = e[i].centerY - d), (l = v(s * s + h * h)) < f && ((g = i), (f = l))
  ...
  function da(t, e, n, r, o) {
    ...
    if (u[0]) {
      ...
      if (p)
        for (
          p < 0 && (p = -p), f[0].length > u[0].length && ca(u[0], ((f[0].length - u[0].length) / 6) | 0), v = u.length;
          d < p;
        ...
        (a = e[v]),
          ...
          (n = w[v] || 0 === w[v] ? w[v] : 'auto') &&
            (i.closed || (Math.abs(i[0] - i[i.length - 2]) < 0.5 && Math.abs(i[1] - i[i.length - 1]) < 0.5)
              ? 'auto' === n || 'log' === n
                ? ((w[v] = n = _(i, a, !v || !1 === o)), n < 0 && ((y = !0), reverseSegment(i), (n = -n)), Z(i, 6 * n))
                : 'reverse' !== n && (v && n < 0 && reverseSegment(i), Z(i, 6 * (n < 0 ? -n : n)))
              : !y &&
                (('auto' === n &&
                  Math.abs(a[0] - i[0]) +
                    Math.abs(a[1] - i[1]) +
    ...
    for (n = (0.5 * e) / (0.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
      if (((l += n), (s = parseFloat(t[r + 2])), (h = parseFloat(t[r + 3])), 0.999999 < l))
        for (i = 1 / (Math.floor(l) + 1), a = 1; 0.999999 < l; )
          (p += (c + (s - c) * i * a).toFixed(2) + ',' + (g + (h - g) * i * a).toFixed(2) + ' '), l--, a++
      ;(p += s + ',' + h + ' '), (c = s), (g = h)
    }
    return p
  }
          ...
          ha(t),
            (t[1] = (function _offsetPoints(t, e) {
              ...
              var n,
                ...
                s = ''
              for (
                n = 'reverse' === e ? ((r = i - 1), -2) : ((r = (2 * (parseInt(e, 10) || 0) + 1 + 100 * i) % i), 2),
                  o = 0;
                o < i;
                o += 2
              )
  ...
  function ka(t, e) {
    for (var n, r, o, a, i, s, h, l, c, g, p, f, u = t.length, d = 0.2 * (e || 1); -1 < --u; ) {
      for (
        ...
        (o = r[h] - r[h - 2]),
          ...
          (g = w(s, i)),
          (n = Math.abs(c - g) < d) &&
            ((f[h - 2] = c), (f[h + 2] = g), (f[h - 1] = v(o * o + a * a)), (f[h + 3] = v(i * i + s * s))),
          p.push(n, n, 0, 0, n, n)
      r[l] === r[0] &&
        r[1 + l] === r[1] &&
        ((o = r[0] - r[l - 2]),
  ...
  var a,
    ...
    J = {
      ...
      init: function init(t, e, n, r, o) {
        ...
        if (
          ((l = 'POLYLINE' === (a = (t.nodeName + '').toUpperCase()) || 'POLYGON' === a), 'PATH' !== a && !l && !e.prop)
        )
        ...
        if (
          ((h = (function _parseShape(t, e, n) {
            var r, o
            return (
              (!('string' == typeof t) || F.test(t) || (t.match(L) || []).length < 3) &&
                ((r = C(t)[0])
        ...
        if (
          ...
          if (
            ...
            for (
              ...
              for (
                v = u[m], w = d[m], p = v.isSmooth || [], f = w.isSmooth || [], _ = v.length, P = j = 0;
                P < _;
                P += 2
              )
                (w[P] === v[P] && w[P + 1] === v[P + 1]) ||
      ...
      render: function render(t, e) {
        ...
        if (1 === t && e._apply)
          for (v = e._pt; v; )
            v.end && (e._prop ? (_[e._prop] = v.end) : _.setAttribute(v.endProp, v.end)), (v = v._next)
        else if (u) {
          for (; P; )
            (i = P.sa + t * P.ca),
              (a = P.sl + t * P.cl),
          ...
          if (((_._gsRawPath = u), e._apply)) {
            for (n = '', h = 0; h < u.length; h++)
              for (
                a = (o = u[h]).length, n += 'M' + ((o[0] * m) | 0) / m + ' ' + ((o[1] * m) | 0) / m + ' C', s = 2;
                s < a;
                s++
              )
                n += ((o[s] * m) | 0) / m + ' '
