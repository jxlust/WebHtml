...
!(function (e, t) {
  ...
  var g,
    ...
    T = function _setDoc(e) {
      ...
      if (((u = window), (m = new fe()), t)) {
        ...
        i &&
          ...
          (i.appendChild(o),
          o.appendChild(n),
          o.setAttribute('style', 'position:static;transform:translate3d(0,0,1px)'),
          (x = n.offsetParent !== o),
          i.removeChild(o))
      }
      return t
    ...
    P = function _isFixed(e) {
      return (
        'fixed' === u.getComputedStyle(e).position || ((e = e.parentNode) && 1 === e.nodeType ? _isFixed(e) : void 0)
      )
    },
    L = function _placeSiblings(e, t) {
      ...
      if ((d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), (o = l ? f : h), l))
        c
          ...
          o.setAttribute(
            'transform',
            'matrix(' + n.a + ',' + n.b + ',' + n.c + ',' + n.d + ',' + (n.e + r) + ',' + (n.f + a) + ')',
          )
      else {
        if (((r = a = 0), x))
  ...
  function fa(e, t) {
    var o = xe.createElementNS
      ? xe.createElementNS((t || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), e)
      : xe.createElement(e)
  ...
  function Pa(e) {
    if (e === ve)
      return (
        ...
        (p.height = p.bottom =
          (e.innerHeight || 0) - 20 < be.clientHeight ? be.clientHeight : e.innerHeight || s.clientHeight || 0),
        p
      )
  ...
  function Qa(e, t, o) {
    var n,
      ...
      a = e._listeners[t]
    return (
      Z(r) && (n = r.apply(i.callbackScope || e, i[o + 'Params'] || [e.pointerEvent])),
  ...
  function Va(e) {
    ...
    return (
      ...
      (!(
        ...
        ('false' === t || (!n.test(e.nodeName + '') && 'true' !== e.getAttribute('contentEditable')))
      ) ||
        Va(e.parentNode))
    )
  }
          ...
          (i && r.clientHeight === s && p.offsetHeight === l && v === r.scrollWidth && x === r.scrollHeight && !e) ||
            ...
            (i && !e) ||
              ...
              (b = Math.max(0, r.scrollWidth - r.clientWidth)) &&
                (b += parseFloat(t.paddingLeft) + (B ? parseFloat(t.paddingRight) : 0))),
  ...
  function Draggable(g, p) {
          ...
          (t = (o = Ge(c.parentNode)) ? We : c.parentNode),
            ...
            j &&
              ((l = t._gsMaxScrollY - t.scrollTop) < 0
                ...
                : r < n.top + oe &&
                  t.scrollTop &&
                  ((te = !0), (s = -Math.min(t.scrollTop, (d * (1 - Math.max(0, r - n.top) / oe)) | 0))),
              s && (t.scrollTop += s)),
            U &&
              ((l = t._gsMaxScrollX - t.scrollLeft) < 0
                ...
                : i < n.left + re &&
                  t.scrollLeft &&
                  ((te = !0), (a = -Math.min(t.scrollLeft, (d * (1 - Math.max(0, i - n.left) / re)) | 0))),
              a && (t.scrollLeft += a)),
      ...
      if (P) {
        ...
        G
          ...
          ? (j && ((q.deltaY = u - parseFloat(le.y)), (le.y = u + 'px')),
            ...
            le.renderTransform(1, le))
          : (j && ((q.deltaY = u - parseFloat(g.style.top || 0)), (g.style.top = u + 'px')),
            U && ((q.deltaX = p - parseFloat(g.style.left || 0)), (g.style.left = p + 'px'))),
          !f ||
            e ||
            H ||
            (!(H = !0) === Qa(q, 'drag', 'onDrag') && (U && (q.x -= q.deltaX), j && (q.y -= q.deltaY), Ai(!0)),
            (H = !1))
      }
      P = !1
    }
      ...
      ;(k = !1),
        ...
        p.liveSnap &&
          ...
          G
            ...
            : (U && (L = Ci(n ? o : o.x || o.left || o.scrollLeft, D, S, h ? -1 : 1)),
              j && (z = Ci(n ? o : o.y || o.top || o.scrollTop, E, A, h ? -1 : 1))))
    }
    function Fi() {
        ...
        ? (!0 === e &&
          ...
          e.duration ||
            (e.duration = {
              ...
              min: isNaN(p.minDuration) ? (0 === r || ($(e) && 1e3 < e.resistance) ? 0 : 0.5) : p.minDuration,
              overshoot: r,
            }),
          (q.tween = i =
            me.to(h || g, {
    ...
    function Ii(e) {
      ...
      ;(B = getGlobalMatrix(g.parentNode, !0)),
        e &&
          q.isPressed &&
          !B.equals(o || new fe()) &&
          ((t = o.inverse().apply({ x: y, y: w })), B.apply(t, t), (y = t.x), (w = t.y)),
        B.equals(i) && (B = null)
    }
    function Ji() {
      var e,
    ...
    function Mi(e, t) {
      ...
      if (
        ...
        q.isPressed ||
        !e ||
        (!(('mousedown' !== e.type && 'pointerdown' !== e.type) || t) && Re() - se < 30 && Me[q.pointerEvent.type])
      )
        O && e && u && Ba(e)
      else {
        if (
          ...
          (q.pointerEvent = e),
          Me[e.type]
            ? ((b = ~e.type.indexOf('touch') ? e.currentTarget || e.target : de),
              za(b, 'touchend', he),
              za(b, 'touchmove', ue),
              za(b, 'touchcancel', he),
              za(de, 'touchstart', Ea))
        ...
        if (
          ...
          for (o = J.length; -1 < --o; )
            me.set(J[o], { cursor: p.activeCursor || p.cursor || ('grab' === Ae ? 'grabbing' : Ae) })
        Qa(q, 'press', 'onPress')
      }
    }
    function Qi(e) {
      if (e && q.isDragging && !h) {
        ...
        ;(o || n) &&
          (B ? ((y -= o * B.a + n * B.c), (w -= n * B.d + o * B.b)) : ((y -= o), (w -= n)),
          (t._gsScrollX += o),
          (t._gsScrollY += n),
    ...
    function Ri(e) {
      ...
      if (
        ((i || (n && !1 !== q.vars.suppressClickOnDrag)) && e.stopImmediatePropagation && e.stopImmediatePropagation(),
        o && (!q.pointerEvent || !q.pointerEvent.defaultPrevented) && (!i || (s && !a)))
      )
        return s && i && (c = se), void (I = se)
      ;(q.isPressed || n || o) && ((s && e.detail && o && !r) || Ba(e)),
        o || n || F || (e && e.target && (q.pointerEvent = e), Qa(q, 'click', 'onClick'))
    }
    function Si(e) {
        ...
        if (u && !ke && q.isPressed && e) {
          ...
          (((r = Math.abs(o - y)) !== (a = Math.abs(n - w)) && (K < r || K < a)) || (Se && R === Y)) &&
            ...
            !1 !== q.vars.lockAxisOnTouchScroll &&
              U &&
              j &&
              ((q.lockedAxis = 'x' === Y ? 'y' : 'x'), Z(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, s)),
            Se && R === Y))
            ? he(s)
            : ((O = q.allowEventDefault || (R && (!Y || R === Y)) || !1 === s.cancelable ? O && !1 : (Ba(s), !0)),
              q.autoScroll && (te = !0),
        ...
        ;(q.pointerX = e),
          ...
          G
            ? ((a = Math.atan2(C.y - t, e - C.x) * Be),
              180 < (s = q.y - a) ? ((M -= 360), (q.y = a)) : s < -180 && ((M += 360), (q.y = a)),
              (r = q.x !== T || Math.abs(M - a) > K ? ((q.y = a), T + (M - a) * c) : T))
            : (B && ((l = e * B.a + t * B.c + B.e), (t = e * B.b + t * B.d + B.f), (e = l)),
              ...
              (q.lockAxis || q.lockedAxis) &&
                (n || i) &&
                ((l = q.lockedAxis) ||
                  ((q.lockedAxis = l = U && Math.abs(n) > Math.abs(i) ? 'y' : j ? 'x' : null),
                  l && Z(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, q.pointerEvent)),
                'y' === l ? (i = 0) : 'x' === l && (n = 0)),
              (r = da(T + n * c)),
              (a = da(M + i * c))),
          (L || z || X) &&
            (q.x !== r || (q.y !== a && !G)) &&
            (X && ((Fe.x = r), (Fe.y = a), (l = X(Fe)), (r = da(l.x)), (a = da(l.y))),
            L && (r = da(L(r))),
            z && (a = da(z(a)))),
          k &&
            (S < r ? (r = S + Math.round((r - S) * d)) : r < D && (r = D + Math.round((r - D) * d)),
            G || (A < a ? (a = Math.round(A + (a - A) * d)) : a < E && (a = Math.round(E + (a - E) * d)))),
          (q.x === r && (q.y === a || G)) ||
            (G
              ? ((q.endRotation = q.x = q.endX = r), (P = !0))
              : (j && ((q.y = q.endY = a), (P = !0)), U && ((q.x = q.endX = r), (P = !0))),
            ...
            (n = J[o]),
              ...
              n.getBBox &&
                ...
                me.set(n.ownerSVGElement, {
                  touchAction:
                    p.allowNativeTouchScrolling || p.allowEventDefault ? 'manipulation' : U ? 'pan-y' : 'pan-x',
                }),
        ...
        if ('soft' !== e) {
          for (ta(J, null), n = J.length; -1 < --n; )
            (t = J[n]),
              ...
              Aa(t, 'contextmenu', zi)
          Wa(J, !0),
            b && (Aa(b, 'touchcancel', he), Aa(b, 'touchend', he), Aa(b, 'touchmove', ue)),
            Aa(de, 'mouseup', he),
            Aa(de, 'mousemove', ue)
        }
        return (
          ...
          De &&
            'soft' !== e &&
            (De.untrack(h || g, W ? 'x,y' : G ? 'rotation' : 'top,left'), q.tween && q.tween.kill()),
          h && h.disable(),
          xa(Ai),
  ...
  function Lb(e, t, o) {
    ...
    return (
      ...
      'svg' === e && (n.setAttribute('xmlns', de), n.setAttribute('xmlns:xlink', pe)),
      o && (n.style.cssText = o),
      n
    )
  }
  ...
  function Qb(e, t, o, n) {
    ...
    return (
      ub(e) &&
        ('=' === e.charAt(1)
          ? ((i = parseInt(e.charAt(0) + '1', 10) * parseFloat(e.substr(2))) < 0 && 0 === n && (n = 100),
            (e = (n / 100) * t.duration() + i))
          : isNaN(e) && t.labels && -1 !== t.labels[e]
          ? (e = t.labels[e])
          : t === q &&
            (0 < (r = e.indexOf('='))
              ? ((i = parseInt(e.charAt(r - 1) + '1', 10) * parseFloat(e.substr(r + 1))), (e = e.substr(0, r - 1)))
              : (i = 0),
            (a = Q.getById(e)) &&
              (e =
  ...
  function Ub(t, e, o, n) {
    ...
    if (
      ...
      'mousedown' === e && (r = xb(t.onpointerdown) ? (xb(t.ontouchstart) ? null : 'touchstart') : 'pointerdown'))
    )
      return (
  ...
  function Vb(e, t, o) {
    e.removeEventListener(t, o),
      (t =
        'mousedown' !== t ? null : xb(e.onpointerdown) ? (xb(e.ontouchstart) ? null : 'touchstart') : 'pointerdown') &&
        e.removeEventListener(t, o)
  }
  function Wb(e, t, o, n) {
    var i,
    ...
    if (te) {
      for (e = q._dur; n; )
        (t = n._next),
          ...
          (vb(o) && o === n.vars.onComplete && !n._dur) || (o && o._gsIgnore) || q.add(n, n._start - n._delay),
          (n = t)
      return e !== q.duration()
    }
  }
    ...
    ;(Q = e || tb()),
      U ||
        (Q &&
          ...
          ne.to({}, { duration: 1e12 }),
          (q = Q.timeline(
            { data: 'root', id: 'Global Timeline', autoRemoveChildren: !1, smoothChildTiming: !0, parent: ne },
            0,
          )),
          (ee = Q.to(
            q,
  ...
  var Q,
    ...
    de = (true, 'http://www.w3.org/2000/svg'),
    ...
    Ze = function GSDevTools(r) {
        ...
        if ((mo('loop', (d = e)), d)) {
          if ((L.play(), v.progress() >= D / 100)) {
            ...
            t === i && t.seek(s + ((l - s) * S) / 100),
              i._repeat && !S && 100 === D ? v.totalProgress(0, !0) : v.progress(S / 100, !0),
              H()
          }
        } else L.reverse()
      }
        ...
        var e,
          ...
          o = (function _getChildrenOf(e, t) {
            for (var o = [], n = 0, i = Q.core.Tween, r = e._first; r; )
              r instanceof i
                ? r.vars.id && (o[n++] = r)
                : (t && r.vars.id && (o[n++] = r), (n = (o = o.concat(_getChildrenOf(r, t))).length)),
                (r = r._next)
            return o
        ...
        for (a && !r.globalSync ? o.unshift(a) : r.hideGlobalTimeline || o.unshift(q), t = 0; t < o.length; t++)
          ((e = n[t] || Lb('option', A)).animation = o[t]),
            ...
            e.setAttribute(
              'value',
              (e.innerHTML =
                o[t].vars.id + (i ? ' [' + i + ']' : o[t + 1] && o[t + 1].vars.id === o[t].vars.id ? ' [0]' : '')),
            )
        ...
        if (
          ...
          if (
            ...
            if ((te === p && (te = null), (s = Math.min(S * i.duration(), i.time())), i !== a && a)) {
              ...
              o < l - s && (l = s + o),
                a.pause(s),
                (v = Q.to(a, { duration: l - s, time: l, ease: 'none', data: 'root', parent: ne }, ne._time))
      ...
      function jp() {
        ...
        v.timeScale(t),
          ...
          C ||
            (v.progress() >= D / 100
              ? ((e = v._targets && v._targets[0]) === i && e.seek(s + ((l - s) * S) / 100),
      ...
      function rp(e) {
        ...
        t && ((t._inProgress = no('in') || 0), (t._outProgress = no('out') || 100)),
          r.paused && I(),
          (i = null),
          gp(a || t || q)
        ...
        o && (Wb(z, o, X, o + 'x'), v.timeScale(o)),
          100 === (S = ('inTime' in r ? Qb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) &&
            !r.animation &&
            t &&
      ...
      var u,
        ...
        n = (function _createRootElement(e, t, o) {
          ...
          return (
            ...
            !t &&
              n.offsetWidth < 600 &&
              (n.setAttribute('class', 'gs-dev-tools minimal'), e && (n.style.top = 'calc(100% - 42px)')),
            n
          )
            ...
            100 < o && (o = 100),
              D <= o
                ? !d || v.paused() || B.isDragging
                  ? ((o === D && -1 !== i._repeat) || ((o = D), v.progress(o / 100)),
                    !C && (D < 100 || 1 === i.totalProgress() || -1 === i._repeat) && I())
                  : n ||
                    ((o = S),
              ...
              (o === T && !0 !== e) ||
                ...
                h &&
                  ((x.style.transform = 'translate(-50%,0)'), (x._gsap.x = '0px'), (x._gsap.xPercent = -50), (h = !1)),
                (T = o)),
              v.paused() !== C && O()
          }
        },
        H = function play() {
          if (v.progress() >= D / 100) {
            ...
            e === i && e.seek(s + ((l - s) * S) / 100),
              v._repeat && !S ? v.totalProgress(0, !0) : v.reversed() || v.progress(S / 100, !0)
          }
        ...
        F = Q.to(
          ...
          { duration: 0.3, autoAlpha: 0, y: 50, ease: 'power2.in', data: 'root', paused: !0, parent: ne },
          ne._time,
        ),
        W = !1,
        G = ie(1.3, np).pause()
