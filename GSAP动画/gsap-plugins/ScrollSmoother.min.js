  ...
  function ScrollSmoother(t) {
    ...
    function Va(e) {
      return arguments.length
        ? (e < 0 && (e = 0), (z.y = -e), (g = !0), f ? (H = -e) : Ua(-e), Z.isRefreshing ? i.update() : E(e / A), this)
        : -H
    }
    function Ya(e) {
      ;(w.scrollTop = 0),
        (e.target.contains && e.target.contains(w)) ||
          (_ && !1 === _(o, e)) ||
          (Z.isInViewport(e.target) || e.target === p || o.scrollTo(e.target, !1, 'center center'), (p = e.target))
    }
    function Za(t, e) {
          ...
          for (c = 0; c < t.length; c++)
            if (
              ...
              if (((n = f.end - f.start), (o = e._startClamp && f.start < 0))) {
                if (0 < e.start)
                  return (
                    e.setPositions(0, e.end + (e._startNative - e.start), !0), void adjustEffectRelatedTriggers(e, t)
                  )
          ...
          b.forEach(function (e) {
            ...
            e._startClamp && t < 0
              ...
              : (e.ratio < 0 || (e._endClamp && r >= D())) &&
                (n =
                  ((r = D()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) * e.ratio -
                  (e.end - e.start)),
              (e.offset = n || 1e-4),
        ...
        if (arguments.length) {
          ...
          return (
            t !== n &&
              ...
              O && O.observe(n),
              B.set(n, { overflow: 'visible', width: '100%', boxSizing: 'border-box', y: '+=0' }),
        ...
        return arguments.length
          ? ((w =
              ...
              (function _wrap(e) {
                ...
                return (
                  t ||
                    ((t = I.createElement('div')).classList.add('ScrollSmoother-wrapper'),
