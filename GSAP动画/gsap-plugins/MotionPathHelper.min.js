...
!(function (t, e) {
  ...
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      for (B = 0; B < X.length; B += 2)
        (_ = X[B]), (m = X[B + 1]), (X[B] = _ * q + m * V + k), (X[B + 1] = _ * z + m * Y + E)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < y; e++)
      if (
        ...
        o || (v = b = 0),
          (r = r || [0, 0]).push(i, s, v + 1 * _[e + 3], b + 1 * _[e + 4], (v += 1 * _[e + 5]), (b += 1 * _[e + 6])),
          (e += 6)
      else if ('S' === a)
        (c = v),
          (d = b),
        ...
        (c = v - r[r.length - 4]),
          (d = b - r[r.length - 3]),
          r.push(v + c, b + d, i + (2 / 3) * (v + 1.5 * c - i), s + (2 / 3) * (b + 1.5 * d - s), (v = i), (b = s)),
          (e += 2)
      else if ('H' === a) zd(v, b, (v = i), b), (e += 1)
      else if ('V' === a) zd(v, b, v, (b = i + (o ? b - v : 0))), (e += 1)
      else if ('L' === a || 'Z' === a)
        'Z' === a && ((i = h), (s = l), (r.closed = !0)),
          ('L' === a || 0.5 < Q(v - i) || 0.5 < Q(b - s)) && (zd(v, b, i, s), 'L' === a && (e += 2)),
          (v = i),
          (b = s)
      else if ('A' === a) {
        if (
    ...
    return (
      (e = r.length) < 6 ? (m.pop(), (e = 0)) : r[0] === r[e - 2] && r[1] === r[e - 1] && (r.closed = !0),
      (m.totalPoints = P + e),
      m
    )
  }
  ...
  function pointsToSegment(t, e) {
    ...
    for (
      S && (t.push(y, P), (y = v), (P = b), (v = t[m - 2]), (b = t[m - 1]), t.unshift(v, b), (m += 4)),
        e = e || 0 === e ? +e : 1,
        a = 2;
      a < m;
      a += 2
      ...
      (i = v),
        ...
        (v === y && b === P) ||
          ...
          (g =
            v -
            ((d = v - (v - i) * (h ? c / h : 0)) +
              ((((u = v + (y - v) * (l ? c / l : 0)) - d) * ((3 * h) / (h + l) + 0.5)) / 4 || 0))),
          (_ =
            b -
            ((p = b - (b - s) * (h ? c / h : 0)) +
              ((((f = b + (P - b) * (l ? c / l : 0)) - p) * ((3 * h) / (h + l) + 0.5)) / 4 || 0))),
          (v === i && b === s) || A.push(n(d + g), n(p + _), n(v), n(b), n(u + g), n(f + _)))
    return (
      v !== y || b !== P || A.length < 4 ? A.push(n(y), n(P), n(y), n(P)) : (A.length -= 2),
      2 === A.length ? A.push(v, b, v, b, v, b) : S && (A.splice(0, 6), (A.length = A.length - 6)),
      A
    )
  }
  function simplifyPoints(t, e) {
    ...
    return (
      ...
      (function simplifyStep(t, e, n, i, s) {
        ...
        i < m &&
          (2 < a - e && simplifyStep(t, e, a, i, s), s.push(t[a], t[a + 1]), 2 < n - a && simplifyStep(t, a, n, i, s))
  ...
  function getClosestProgressOnBezier(t, e, n, i, s, a, o, r, h, l, c, d, u, g) {
    ...
    for (P = A; y <= s; )
      (p =
        (f = (m = 1 - y) * m * m * o + 3 * m * m * y * h + 3 * m * y * y * c + y * y * y * u - e) * f +
        (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * g - n) * _) < P && ((P = p), (b = y)),
        (y += v)
    return 1 < t
      ? getClosestProgressOnBezier(t - 1, e, n, Math.max(b - v, 0), Math.min(b + v, 1), a, o, r, h, l, c, d, u, g)
      : b
  }
  function B(t) {
    ...
    if (((p = window), (v = new D()), e)) {
      ;(f = (g = e).documentElement),
        (_ = e.body),
        ((b = g.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform = 'none')
  ...
  function M(t, e) {
    ...
    if ((c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), (n = h ? m : u), h))
      l
        ...
        n.setAttribute(
          'transform',
          'matrix(' + i.a + ',' + i.b + ',' + i.c + ',' + i.d + ',' + (i.e + a) + ',' + (i.f + o) + ')',
        )
    else {
      if (((a = o = 0), y))
        for (i = t.offsetParent, s = t; (s = s && s.parentNode) && s !== i && s.parentNode; )
          4 < (p.getComputedStyle(s)[S] + '').length && ((a = s.offsetLeft), (o = s.offsetTop), (s = 0))
  ...
  function pa(t, e, n) {
    ...
    for (i in (((n = n || {}).class = n.class || 'path-editor'), n))
      void 0 !== s.style[i] ? (s.style[i] = n[i]) : s.setAttributeNS(null, i.replace(a, '$1-$2').toLowerCase(), n[i])
    ...
    if (
      ...
      return (
        a && !o && n.vars.onDragRelease
          ...
          : (a && na(a), n.vars.onRelease && n.vars.onRelease.call(n.vars.callbackScope || n, n.pointerEvent)),
      ...
      (((q = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
        ...
        ;(this.pointerX = t),
          ...
          (this.x === s && this.y === a) ||
            ...
            !this.isDragging && this.isPressed && ((this.isDragging = !0), Ha('onDragStart', this, this.pointerEvent)))
      }),
      ...
      (ht.update = function update(t, e, n) {
        ...
        ;(this.segment = s),
          (this.smooth =
            0 < n &&
            n < s.length - 2 &&
            Math.abs(Math.atan2(s[n + 1] - s[1 + a], s[n] - s[a]) - Math.atan2(s[n + 3] - s[n + 1], s[n + 2] - s[n])) <
              0.09
              ? 2
              : 0),
          this.smooth !== i &&
    ...
    dt =
        ...
        return (
          ...
          this._g.setAttribute(
            ...
            (function _getConcatenatedTransforms(t) {
              for (var e = ra(t), n = t.ownerSVGElement; (t = t.parentNode) && t.ownerSVGElement === n; )
                e.multiply(ra(t))
      ...
      (ct._onPressAnchor = function _onPressAnchor(t) {
        ;-1 === this._selectedAnchors.indexOf(t)
          ...
          : L && (this._selectedAnchors.splice(this._selectedAnchors.indexOf(t), 1), t._draggable.endDrag()),
          (K.x = t.segment[t.i]),
          (K.y = t.segment[t.i + 1]),
          this._updateAnchors(),
          Ha('onPress', this)
      ...
      (ct._updateAnchors = function _updateAnchors() {
        ...
        for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++)
          this._anchors[t].element.style.fill = -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? V : 'white'
        i &&
      ...
      (ct._onDragAnchor = function _onDragAnchor(t, e, n) {
        ...
        for (s = 0; s < l; s++)
          (i = (o = h[s]).i),
            ...
            (a[i + 1] = (((a[i + 1] + n) * c) | 0) / c),
            i < a.length - 2 &&
              ((a[i + 2] = (((a[i + 2] + e) * c) | 0) / c), (a[i + 3] = (((a[i + 3] + n) * c) | 0) / c)),
        ...
        if (
          ...
          r &&
            ...
            e < n.length - 2 &&
              ((i = n[e + 2]),
              (s = n[e + 3]),
              this._handle2.setAttribute('transform', 'translate(' + i + it + s + ')'),
              this._line2.setAttribute('points', n[e] + it + n[e + 1] + it + i + it + s))),
          t)
        )
          o = this.path.getAttribute('d')
        else {
          for (e = 0; e < this._rawPath.length; e++)
            7 < (n = this._rawPath[e]).length && (o += 'M' + n[0] + it + n[1] + 'C' + n.slice(2).join(it))
        ...
        if (t) {
          ...
          return (function rawPathToString(t) {
            ...
            var e,
              ...
              r = t.length
            for (i = 0; i < r; i++) {
              for (a = t[i], o += 'M' + n(a[0]) + ',' + n(a[1]) + ' C', e = a.length, s = 2; s < e; s++)
                o +=
                  n(a[s++]) +
                  ',' +
                  n(a[s++]) +
      ...
      (ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          p = 1 / (c[g - 2] + d),
          f = -t || c[g - 1] + u
        for (f = f ? 1 / f : -p, p *= 1e3, f *= 1e3, a = nt.length = 0; a < g; a += 2)
          (nt[a] = (((c[a] + d) * p) | 0) / 1e3), (nt[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3)
        if (i) {
          for (s = [], g = nt.length, a = 2; a < g; a += 6)
            (o = nt[a - 2]),
              ...
              (l = nt[a + 5]),
              s.push(o, r, h, l),
              bezierToPoints(o, r, nt[a], nt[a + 1], nt[a + 2], nt[a + 3], h, l, 0.001, s, s.length - 2)
        ...
        return n && 8 === g && 0 === nt[0] && 0 === nt[1] && 1 === nt[g - 2] && 1 === nt[g - 1]
          ? nt.slice(2, 6).join(',')
  ...
  function PathEditor(t, e) {
    ...
    ;(this._squareHandle = (function _getSquarePathData(t) {
      ...
      (this._circleHandle = (function _getCirclePathData(t) {
        ...
        return (
          ...
          (t = ua(t)) +
          ',0C' +
          [t, e, e, t, 0, t, -e, t, -t, e, -t, 0, -t, -e, -e, -t, 0, -t, e, -t, t, -e, t, 0].join(it) +
          'z'
        )
      })(1.15 * i)),
    ...
    !1 !== e.draggable &&
      ...
      this._saveState(),
      h ||
        (Ba(this._selectionHittest, 'mousedown', Ga(this._onClickSelectionPath, this)),
      ...
      if (
        ...
        for (l = i, i = [], u = l.length, s = 2; s < u; s += 6)
          (a = +l[s - 2]),
            ...
            bezierToPoints(a, r, +l[s], +l[s + 1], +l[s + 2], +l[s + 3], o, h, 1 / (2e5 * c), i, i.length - 2)
  ...
  function kb(t, e) {
    var n = pt.createElementNS
      ? pt.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : pt.createElement(t)
    return n.style ? n : pt.createElement(t)
  }
  function qb(t, e, n) {
    return jb(t) && xt.test(t)
      ? pt.querySelector(t)
      : Array.isArray(t)
      ? bt(vt([{ x: ut.getProperty(e, 'x'), y: ut.getProperty(e, 'y') }].concat(t), n))
      : jb(t) || (t && 'path' === (t.tagName + '').toLowerCase())
      ? t
      : 0
  }
  function vb(t, e) {
    ...
    ;(gt = window),
      ...
      ut && ((mt = ut.plugins.motionPath), (Et.PathEditor = dt), (yt = ut.core.context || function () {})),
      mt
  ...
  function MotionPathHelper(t, e) {
    ...
    t instanceof ut.core.Tween
      ...
      c && !s && (s = qb(c.vars.motionPath.path || c.vars.motionPath, i, c.vars.motionPath)),
      ...
      (function _addCopyToClipboard(n, i, s) {
        ...
        function () {
          return ut.fromTo(m, { backgroundColor: 'white' }, { duration: 0.5, backgroundColor: 'rgba(85, 85, 85, 0.6)' })
        },
      ),
