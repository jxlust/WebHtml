...
// // 例三
// const elSet = new Set(document.querySelectorAll('div'));
// elSet.size // 56
...
var mapArr = [...mapSort].sort(function ([k1, v1], [k2, v2]) {
    return v2 - v1;
})
console.log(mapArr);
...
console.log('match：',isMatch("(1<<<3)>(8>>2)>")); 
